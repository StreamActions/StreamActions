...
/// <summary>
/// An <see cref="EventSubCondition{T}"/> containing the <c>broadcaster_user_id</c> field.
/// </summary>
public sealed record BroadcasterUserIdCondition : EventSubCondition<BroadcasterUserIdCondition>
{
    /// <summary>
