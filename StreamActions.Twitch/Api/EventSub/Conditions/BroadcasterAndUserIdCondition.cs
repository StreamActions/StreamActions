...
/// <summary>
/// An <see cref="EventSubCondition{T}"/> containing the <c>broadcaster_user_id</c> and <c>user_id</c> fields.
/// </summary>
public sealed record BroadcasterAndUserIdCondition : EventSubCondition<BroadcasterAndUserIdCondition>
{
    /// <summary>
