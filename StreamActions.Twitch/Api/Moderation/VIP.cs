...
public sealed record VIP
{
    ...
    /// <exception cref="TwitchScopeMissingException"><paramref name="session"/> does not have the scope <see cref="Scope.ChannelReadVips"/> or <see cref="Scope.ChannelManageVips"/>.</exception>
    /// <remarks>
    /// <para>
