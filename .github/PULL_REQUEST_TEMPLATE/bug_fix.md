...
* The pull request must only fix an existing bug. To contribute other changes, you must use a different template. You can see all templates at <https://github.com/StreamActions/StreamActions-Bot/tree/master/.github/PULL_REQUEST_TEMPLATE>.
